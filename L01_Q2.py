...
#ii. Define time array Note that dt=0.0001 yr.

#iii. Initialize position (x and y) arrays and velocity (vx and vy) arrays for \
#Jupiter
...
plt.title('Jupiter Orbit Over 10 Earth Years', fontsize = 15)
...
plt.title('Orbits Over 10 Earth Years',fontsize = 15)
plt.xlabel('x [AU]', fontsize = 15)
plt.ylabel('y [AU]', fontsize = 15)
plt.axis('square')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
plt.title('Orbits Over 3.5 Earth Years (MJ = 1000MJ)', fontsize = 15)
plt.xlabel('x [AU]', fontsize = 15)
plt.ylabel('y [AU]', fontsize = 15)
plt.axis('square')
plt.xlim(-10,10)
...
plt.title('Orbits Over 20 Earth Years', fontsize = 15)
plt.xlabel('x [AU]', fontsize = 15)
plt.ylabel('y [AU]', fontsize = 15)
plt.axis('square')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
